...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if epoch % 5 == 0:
        ...
        torch.save(netG_A2B.state_dict(),
                   '/content/gdrive/MyDrive/Handwritten-Kanji-checkpoints/netG_A2B/latest_netG_A2B.pth'.format(epoch))
        torch.save(netG_B2A.state_dict(),
                   '/content/gdrive/MyDrive/Handwritten-Kanji-checkpoints/netG_B2A/latest_netG_B2A.pth'.format(epoch))
        torch.save(netD_A.state_dict(),
                   '/content/gdrive/MyDrive/Handwritten-Kanji-checkpoints/netD_A/latest_netD_A.pth'.format(epoch))
        torch.save(netD_B.state_dict(),
                   '/content/gdrive/MyDrive/Handwritten-Kanji-checkpoints/netD_B/latest_netD_B.pth'.format(epoch))
